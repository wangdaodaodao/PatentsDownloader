...
def get_pdf(no = 'CN201510708735.4'):
    ...
    response_securepdf = session.post(securepdf_url, headers=headers_securepdf, data = data_securepdf)

    headers_getpdf['Host'] = host_name
    headers_getpdf['Referer'] = 'http://{}/cnpat/SecurePdf.aspx'.format(host_name)

    file_url = 'http://{}/cnpat/package/%E5%8F%91%E6%98%8E%E4%B8%93%E5%88%A9%E7%94%B3%E8%AF%B7%E8%AF%B4%E6%98%8E%E4%B9%A6{}.pdf'.format(host_name, no)
